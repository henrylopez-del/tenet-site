...
## Estructura
- `index.html` — sitio principal (ES)
- `404.html` — TIME INVERTED
- `assets/site.css` — estilos
- `assets/img/` — mockups TENET v8 (Drop 01, Q2 2026)
- `assets/textures/` — grain · halftone · paper SVG
- `assets/favicon.svg` — TNT mark

## Brand identity
Ver `~/Desktop/HenryBrain/wiki/projects/tenet/tenet-brand-identity-v8.md`
...
## Audio tick
Por default OFF (respeto al usuario · Sutherland).
Activable vía `?tick=1` en la URL.
